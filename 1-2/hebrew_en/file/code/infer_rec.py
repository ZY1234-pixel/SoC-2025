...
def main():
    ...
    reverse_rtl_text = global_config.get("reverse_rtl_text", False)
    ...
    save_res_path = config["Global"].get(
        "save_res_path", "./output/hebrew150_30000_rec_v2/hebrew150_predictions.txt"
    )
        ...
        for file in get_image_file_list(infer_imgs, infer_list=infer_list):
            ...
            if isinstance(post_result, dict):
                ...
                if len(post_result[0]) >= 2:
                    ...
                    if reverse_rtl_text:
                        text = reverse_reversed_rtl_text(text)
                    info = text + "\t" + str(post_result[0][1])
