...
def main():
    ...
    parse.add_argument("-f", "--file", type=str, default="/home/fauyn/Aproject/watermark/CDLA_DATASET/val_mask/val_0001.jpg",
                       help="image file path or directory")
    parse.add_argument("-m", "--mark", type=str, default="测试一句话行不行", help="watermark content")
    parse.add_argument("-o", "--out", default="/home/fauyn/Aproject/watermark/CDLA_DATASET/val/val_0001.jpg",
