...
from input.load import load_lang_file
from recognition.languages import replace_lang_with_code
from scripts.config import CLILoader
from detection import DetectionPredictor
from recognition import RecognitionPredictor
from debug.text import draw_text_on_image

def ocr_text(input_path, langs=None, lang_file= None, **kwargs):
