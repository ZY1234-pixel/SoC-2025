...
from common.s3 import S3DownloaderMixin
from transformers import PreTrainedModel
from detection.model.config import EfficientViTConfig
...
class EfficientVitLarge(nn.Module):
    def __init__(
        ...
        # input stem
        self.stem = Stem(config.num_channels, config.widths[0], config.depths[0], config.strides[0], norm_layer,
                         act_layer, block_type='large')
