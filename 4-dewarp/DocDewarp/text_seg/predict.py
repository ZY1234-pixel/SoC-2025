...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    count           = False
    name_classes    = ["background","horizon_line","vertical_line"]
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "/home/tjq/download/datasets/book_100_masked_persp/persp_fullmask/input/"
    dir_save_path   = "/home/tjq/download/datasets/book_100_masked_persp/persp_fullmask/output/"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        for img_name in tqdm(img_names):
            if img_name.lower().endswith(('.bmp', '.dib', '.png', '.jpg', '.jpeg', '.pbm', '.pgm', '.ppm', '.tif', '.tiff')):
                ...
                max_memory = max(max_memory, initial_memory)
                r_image     = unet.detect_image(image,image_name=os.path.splitext(img_name)[0],save_dir=dir_save_path)
                final_memory = get_memory_usage()
                max_memory = max(max_memory, final_memory)
                print(f"Memory peak usage: {max_memory:.2f} MB")
